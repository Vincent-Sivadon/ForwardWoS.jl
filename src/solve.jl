...
"""
function Solve(p::Problem; ngrid=50, nwalks=200, ϵ=0.001)
...
function SolveGPU(p::Problem; ngrid=50, nwalks=200, ϵ=0.001)
    idim,odim,axs,u = preprocess(p,ngrid)
...
function walks(p::Problem,coords,nwalks,odim,ϵ)

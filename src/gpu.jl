...
function PreprocessGPU_2Dscalar(p::Problem,axs,u,nwalks,ϵ)
    ngrid = size(u)[1]
...
function GPU_2Dscalar(p::LaplaceProblem,axs,u,nwalks,ϵ)
...
function GPU_2Dscalar(p::PoissonProblem,axs,u,nwalks,ϵ)
    x_d,y_d,u_d,threads,blocks = PreprocessGPU_2Dscalar(p,axs,u,nwalks,ϵ)
